...
describe('FeedbackWidget', () => {
  ...
  it('renders idle state with feedback link', () => {
    render(<FeedbackWidget sourceType="newsletter" sourceId="00000000-0000-0000-0000-000000000001" />);
  ...
  it('shows confirmation on successful submit', async () => {
    ...
    render(<FeedbackWidget sourceType="query" sourceId="00000000-0000-0000-0000-000000000002" />);
    fireEvent.click(screen.getByText(/something wrong/i));
  ...
  it('shows error and keeps form open on failed submit', async () => {
    ...
    render(<FeedbackWidget sourceType="reflection" sourceId="00000000-0000-0000-0000-000000000003" />);
    fireEvent.click(screen.getByText(/something wrong/i));
