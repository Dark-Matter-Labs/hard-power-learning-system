  ...
  return (
    <div className="absolute left-0 top-0 bottom-0 z-30 flex">
      ...
      <button
        ...
        className="absolute top-[57px] w-5 h-10 bg-gray-800/80 hover:bg-gray-700 rounded-r flex items-center justify-center text-gray-500 hover:text-gray-300 transition-colors"
